...
const Footer = () => {
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/aryankuttarmare14',
      icon: <Github className="h-5 w-5" />,
    },
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/aryankuttarmare/',
      icon: <Linkedin className="h-5 w-5" />,
    },
    {
      name: 'Email',
      url: 'mailto:aryan.kuttarmare2002@gmail.com',
      icon: <Mail className="h-5 w-5" />,
    },
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/aryan_kuttarmare',
      icon: <Instagram className="h-5 w-5" />,
    },
    {
      name: 'WhatsApp',
      url: 'https://wa.me/8446529059?text=Hello Aryan! I contacting you through your portfolio.',
      ...
      >
          ...
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-display font-bold text-white">
                <span className="text-flame-500">A</span>ryan Portfolio
              </span>
            </div>
          </div>
        ...
        <div className="border-t border-charcoal-800 mt-8 pt-6 text-center text-charcoal-400 text-sm">
          ...
          >
            ...
            />
            <span className="font-medium text-flame-500">Aryan</span>
          </motion.div>
        </div>
      </motion.div>
    </footer>
